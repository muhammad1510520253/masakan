...
<div class="bookonlinewrapper">
    ...
    <!-- <h3 class="wow fadeInUp" data-wow-delay="0.3s"> Menampilkan semua artikel kategori <?php $artikel->Nama_Kategori; ?></h3> -->
    </div>
</div> 
...
<div class="clients-area center wow fadeInDown">
            <div class="row">
              <?php foreach($artikel as $artikel) { ?>
                ...
                <br>
                <div class="card" style="width: 335px; height: 420px; box-shadow:  10px 10px 10px 10px rgba(0,0,0,0.2);transition: 0.5s;  padding: 16px 16px;" >
  ...
  <div class="card-body">
    <h5 class="card-title" style="text-align: center;"><?php echo $artikel->Judul_Artikel ?></h5>
      ...
      <div  style="text-align: center; vertical-align: middle;"> <a href="<?php echo base_url('kategori/read/'.$artikel->Slug_Artikel) ?>" class="btn btn-success"> Baca Selengkapnya</a></div>
