...
<div class="bookonlinewrapper">
 ...
 <?php $i=$this->input;
    $cari =$i->post('cari'); ?>
    <h3 class="wow fadeInUp" data-wow-delay="0.3s"> hasil pencarian artikel <i><?php echo $cari; ?></i></h3>
    </div>
</div> 
...
<div class="clients-area center wow fadeInDown">
            <div class="row">
              <?php foreach($pencarian as $pencarian) { ?>
  ...
  <img class="card-img-top" src="<?php echo base_url('assets/upload/image/'.$pencarian->Gambar) ?>" alt="Card image cap" style="width: 300px; height: 300px;">
  <hr>
  <div class="card-body">
    <h5 class="card-title" style="text-align: center;"><?php echo $pencarian->Judul_Artikel ?></h5>
   
      <div  style="text-align: center; vertical-align: middle;"> <a href="<?php echo base_url('artikel/read/'.$pencarian->Slug_Artikel) ?>" class="btn btn-success"> Baca Selengkapnya </a></div>
   <hr><hr >
